...
}> = ({ message, isOwn, onLongPress, onPressQuoted, isHighlighted, messageMap = {}, translation, isTranslating }) => {
...
export const ChatScreen = ({ onBackPress, chatUser = null }: ChatScreenProps) => {
  ...
  const renderMessage = useCallback(
    ...
    [currentUserId, handleMessageLongPress, actions, highlightedMessageId, messageMap, getAllUserImages, translatedMessages, translatingMessageId],
  );
